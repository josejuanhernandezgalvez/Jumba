...
public abstract class Optimizer  extends io.intino.magritte.framework.Layer implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public Optimizer(io.intino.magritte.framework.Node node) {
		super(node);
	}
