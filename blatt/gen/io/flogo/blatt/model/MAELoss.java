...
public class MAELoss extends io.flogo.blatt.model.LossFunction implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public MAELoss(io.intino.magritte.framework.Node node) {
		super(node);
	}
