...
public class CrossEntropyLoss extends io.flogo.blatt.model.LossFunction implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public CrossEntropyLoss(io.intino.magritte.framework.Node node) {
		super(node);
	}
