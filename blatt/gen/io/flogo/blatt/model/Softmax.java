...
public class Softmax extends io.flogo.blatt.model.LinkSection implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public Softmax(io.intino.magritte.framework.Node node) {
		super(node);
	}
