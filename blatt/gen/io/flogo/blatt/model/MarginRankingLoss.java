...
public class MarginRankingLoss extends io.flogo.blatt.model.LossFunction implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public MarginRankingLoss(io.intino.magritte.framework.Node node) {
		super(node);
	}
