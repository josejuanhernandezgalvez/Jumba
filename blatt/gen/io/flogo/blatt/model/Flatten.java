...
public class Flatten extends io.flogo.blatt.model.LinkSection implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public Flatten(io.intino.magritte.framework.Node node) {
		super(node);
	}
