...
public abstract class LinkSection extends io.flogo.blatt.model.Section implements io.intino.magritte.framework.tags.Component, io.intino.magritte.framework.tags.Terminal {

	public LinkSection(io.intino.magritte.framework.Node node) {
		super(node);
	}
