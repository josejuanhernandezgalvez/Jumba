...
import io.flogo.builder.model.architecture.blocks.processing.residual.ResidualDefaultLastStage;
...
import io.flogo.model.ResidualSection.CustomLastStage;
...
public class LastStageRenderer extends StageRenderer{
    ...
    public static ConvolutionalBlockView render(ResidualSection.LastStage lastStage, ThreeDimensionsOutput previousOutput) {
        ...
        return createStage((CustomLastStage) lastStage, previousOutput);
    }

    private static ConvolutionalBlockView createStage(CustomLastStage lastStage, ThreeDimensionsOutput previousOutput) {
        return new ConvolutionalBlockView(createViews(lastStage, previousOutput));
    }

    private static List<LayerView> createViews(CustomLastStage lastStage, ThreeDimensionsOutput previousOutput) {
        init(previousOutput);
