...
import io.flogo.builder.model.laboratory.lossfunctions.KullbackLeiblerDivergenceLossView;
...
public class LaboratoryTest {
    ...
    public void should_render_laboratory() {
        ...
        ExperimentView experimentTest = new ExperimentView("Experiment test", new KullbackLeiblerDivergenceLossView(), new AdadeltaView(0.01, 0.05, 0.0001, 0.5),
                new ArrayList<>());
        experiments.add(experimentTest);
        LaboratoryView laboratoryView = new LaboratoryView("Laboratory Test", 1, 10, new KullbackLeiblerDivergenceLossView(),
