...
public record ConvolutionTwoDimensionsKernel(Size size, Stride stride, Padding padding) implements Kernel {
    ...
    public static ConvolutionTwoDimensionsKernel kernelFor(ThreeDimensionsOutputView previousOutput, ThreeDimensionsOutputView thisOutput) {
        return new ConvolutionTwoDimensionsKernel(sizeFor(previousOutput, thisOutput), strideFor(previousOutput, thisOutput), paddingFor(previousOutput, thisOutput));
    }
    ...
    public static ThreeDimensionsOutputView outputFor(ThreeDimensionsOutputView input, ConvolutionTwoDimensionsKernel kernel, int OutChannels) {
    ...
    public ThreeDimensionsOutputView outputFor(ThreeDimensionsOutputView input, int OutChannels) {
        return new ThreeDimensionsOutputView(calculateX(input, this.size, this.padding, this.stride), calculateY(input, this.size, this.padding, this.stride), OutChannels);
    }
