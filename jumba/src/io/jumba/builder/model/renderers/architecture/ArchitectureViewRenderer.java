...
import io.jumba.builder.model.Renderer;
...
import io.jumba.model.Architecture;
...
public class ArchitectureViewRenderer implements Renderer<Architecture, ArchitectureView> {
    ...
    private static final class InputRenderer implements Renderer<Section, OutputView> {
        private final static String directory = "io/jumba/builder/model/architecture/layers/output/";
        private final static String packageRoute = "io.jumba.builder.model.architecture.layers.output.";
        ...
        private Class getInputClassFor(Section section) throws ClassNotFoundException {
            return Class.forName("io.jumba.model." + extractFrom(section) + "$Input");
        }
